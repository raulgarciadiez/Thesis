...
p 'standard_deviation-2-datasets.dat' u ($1<0.15?$1:1/0):2 w l ls 1 not, "<echo '0.0899 0.11'" w p ls 1 ps 1 lc rgb 'black'
...
set out
set term pop
! convert -density 600 plot2.eps plot2.pdf
! convert -density 600 plot2.eps plot2.png
