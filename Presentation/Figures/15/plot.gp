...
set grid
set ylabel 'Diameter / nm' offset 2.5
set autoscale
set xrange[-4.5:4.8]
set yrange [126.:164]#158]
...
p  f(x) lt 1 lw 7 lc rgb 'grey' notitle, g(x) lt 0 lw 9 lc rgb 'grey' notitle, h(x) lt 0 lw 9 lc rgb 'grey' notitle, 'size_imaging.dat' u 1:3:4:($1>0.5 ? 0 : ($1==0.0 ? 2 : 1) ) w yerr lw 3 lt 1 palette notitle, '' u 1:3:($1>0.5 ? 0 : ($1==0.0 ? 2 : 1) ):xtic(2)w points pt 5 ps 2 palette notitle, 'size_DCS.dat' u 1:3:4:($1>0.5 ? 0 : ($1==0.0 ? 1 : 1) ) w yerr lt 1 lw 3 palette notitle, '' u 1:3:($1>0.5 ? 0 : ($1==0.0 ? 1 : 2) ):xtic(2) w points pt 5 ps 2 palette notitle, 'size_SAXS.dat' u 1:3:4:($1>0.5 ? 0 : ($1==0.0 ? 2 : 1) ) w yerr lt 1 lw 3 palette notitle, '' u 1:3:($1>0.5 ? 0 : ($1==0.0 ? 2 : 1) ):xtic(2)w points pt 7 ps 2 palette notitle
