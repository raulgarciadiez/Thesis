...
\begin{figure}%[htbp]
	\centering
		\subfloat[Glass thickness]{\resizebox{0.44\linewidth}{!}{\figfont{13pt}\input{Figures/HilgenbergHomogeneity}}\label{fig:HilgenbergHomogeneity}}
		\subfloat[Sample thickness]{\resizebox{0.44\linewidth}{!}{\figfont{13pt}\input{Figures/WaterHomogeneity}}\label{fig:WaterHomogeneity}}
