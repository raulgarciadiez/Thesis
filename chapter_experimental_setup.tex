...
\begin{figure}%[htbp]
	\centering
		...
		\caption[Radiant power of BESSY II.]{Radiant power of the bending magnets at BESSY II under standard operation (300 mA) through an aperture of 10 x 10 mm$^2$ situated at 30 m of the source \textcolor{red}{calculated with the \emph{Schwinger} program}. The critical energy $E_C$ is 2.5 keV and divides the spectrum into two parts with equal power.}
