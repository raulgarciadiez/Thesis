...
\begin{figure}%[htbp]
	\centering
		\subfloat[Core-shell particle in solvent]{\resizebox{0.5\linewidth}{!}{\input{Figures/ContrastScheme.pdf_tex}}\label{fig:ContrastScheme}}
		\subfloat[Contrast matching of the shell]{\resizebox{0.5\linewidth}{!}{\input{Figures/MatchPointScheme.pdf_tex}}\label{fig:MatchPointScheme}}
