...
\begin{figure*}%[htbp]
	\centering
		\subfloat[SCATTERING PATTERN]{\resizebox{0.45\linewidth}{!}{\figfont{12pt}\input{Figures/ScatteringCurve50nm}}\label{fig:ScatteringPatternExp}}
		\qquad
...
\textcolor{red}{THE OTHER TWO COMPONENTS ARE NORMALLY MORE CHALLENGING TO INTERPRET AS THEY HAVE EITHER CONTRIBUTIONS FROM THE CROSS-TERM OR FROM THE FLUCTUATION OF THE ELECTRON DENSITY INSIDE THE NANOPARTICLE FROM A BASE DENSITY}
