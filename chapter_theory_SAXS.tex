...
\begin{figure*}%[htbp]
	\centering
		\subfloat[The scattering pattern]{\resizebox{0.35\linewidth}{!}{\includegraphics{Figures/Au100ScatteringPattern_edit2}}\label{fig:Au100ScatteringPattern}}
		\qquad
		\subfloat[The scattering curve and its relevant regions.]{\resizebox{0.5\linewidth}{!}{\figfont{12pt}\input{Figures/ScatteringCurve50nm}}\label{fig:ScatteringCurve50nm}}
...
\begin{figure*}%[htbp]
	\centering
		...
		\qquad
		\subfloat[Polydisperse ensemble: $p_d=30\;\%$]{\resizebox{0.45\linewidth}{!}{\figfont{12pt}\input{Figures/IsopointSimulationPolydisperse}}\label{fig:IsopointSimulationPolydisperse}}
