...
\begin{figure*}%[htbp]
	\centering
		\subfloat[The scattering pattern]{\resizebox{0.35\linewidth}{!}{\includegraphics{Figures/Au100ScatteringPatternInset}}\label{fig:Au100ScatteringPattern}}
		\qquad
...
\begin{figure*}%[htbp]
	\centering
		\subfloat[Monodisperse nanoparticles]{\resizebox{0.47\linewidth}{!}{\figfont{12pt}\input{Figures/IsopointSimulationIdeal}}\label{fig:IsopointSimulationIdeal}}
		\qquad
		\subfloat[Polydisperse ensemble: $p_d=30\;\%$]{\resizebox{0.47\linewidth}{!}{\figfont{12pt}\input{Figures/IsopointSimulationPolydisperse}}\label{fig:IsopointSimulationPolydisperse}}
