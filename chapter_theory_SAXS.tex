...
For a revolution ellipsoid with two equal semi-axis $R$ and semi-principal axes $\nu R $, the squared form factor is expressed as an integral over all the available angles:
