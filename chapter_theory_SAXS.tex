...
\begin{equation}
        \mu = \sum_i \mu^i = \sum_i \rho_e^i \sigma^i  =N_A\sum_1  \frac{Z^i}{A^i} \rho^i \sigma^i
\end{equation}

where $N_A$ is the Avogadro constant, $\sigma$ is the attenuation cross-section and $\rho_e$ is the number density of absorbing centers. In the X-ray regime, photons interact principally with the atomic electrons, thus the electron density $\rho_e$ is directly proportional to the atomic number $Z$, the atomic mass number $A$ and the physical density $\rho$ of the component $i$. 
...
We will focus principally in the the elastic e.g. coherent scattering for the goals of the work presented here
