...
\begin{figure*}
	\centering
		...
		\caption[Cryo-TEM image and schematic representation of Caelyx.]{a) Cryo-TEM image of Caelyx\textregistered\ \citep{barenholz_doxil_2012} and b) schematic representation of the PEGylated liposomal doxorubicin morphology.}
\end{figure*}
...
%\begin{figure*}
%	\centering
%		\subfloat[SSL 81 nm]{\resizebox{0.6\linewidth}{!}{\figfont{12pt}\input{Figures/SSLSingleContrast}}\label{fig:SSLContinuousSAXS}}
%		\qquad
%		\subfloat[Plain 89 nm]{\resizebox{0.3\linewidth}{!}{\figfont{14pt}\input{Figures/SSLSingleContrastBilayer}}\label{fig:PlainLiposomeContinuousSAXS}}
...
%  \begin{center}
%        {\resizebox{0.6\linewidth}{!}{\figfont{12pt}\input{Figures/SSLSingleContrastBilayer}}}
%  \end{center}
%  \caption{A gull}
%\end{wrapfigure}
