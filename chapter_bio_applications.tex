...
\begin{figure}
	\centering
		...
		\caption{Caelyx in aqueous buffer}
\end{figure}
...
\begin{figure}
	\centering
		...
		\caption{Caelyx in sucrose in SAXS: Osmotic effects}
\end{figure}
...
\begin{figure}
	\centering
		...
		\caption{Caelyx in sucrose WAXS! The mean width (FWHM) is 0.333 nm-1}
\end{figure}
...
\begin{figure}
	\centering
		...
		\caption{Isoscattering point positions depending on the contrast agent: Aqueous sucrose calculated before osmotic shrinkage}
