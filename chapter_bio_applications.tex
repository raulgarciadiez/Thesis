...
In this sense, lipid vesicles, or liposomes, have an increasing importance in the emerging field of nanomedicine, due to their capacity to encapsulate hydrophilic compounds within the closed phospholipid bilayer membrane. The first approved nano-drug, Doxil\textregistered\ (Caelyx\textregistered\ in Europe), consists of a PEGylated liposomal formulation of doxorubicin \citep{barenholz_doxil_2012}. In fact, liposomal nanocarriers are nowadays a widespread instrument for drug delivery \citep{perez-herrero_advanced_2015}.
...
\begin{figure}
	\centering
		\subfloat[SSL 81 nm]{\resizebox{0.44\linewidth}{!}{\figfont{13pt}\input{Figures/SSLContinuousSAXS}}\label{fig:SSLContinuousSAXS}}
		\subfloat[Plain 89 nm]{\resizebox{0.44\linewidth}{!}{\figfont{13pt}\input{Figures/PlainLiposomeContinuousSAXS}}\label{fig:PlainLiposomeContinuousSAXS}}
...
\begin{figure}
	\centering
		\subfloat[PEG 179 nm]{\resizebox{0.44\linewidth}{!}{\figfont{11pt}\input{Figures/SSLContrastCurvesBilayer200SSL}}\label{fig:SSLContrastCurvesBilayer200SSL}}
		\subfloat[Plain 128 nm]{\resizebox{0.44\linewidth}{!}{\figfont{11pt}\input{Figures/SSLContrastCurvesBilayer100Plain}}\label{fig:SSLContrastCurvesBilayer100Plain}}
