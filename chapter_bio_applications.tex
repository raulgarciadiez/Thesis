...
In this chapter, the utilization of continuous contrast variation in SAXS is examined for a nanodrug such as Caelyx$\textregistered$ and typical nanocarriers like lipid vesicles or polymeric colloids. In the latter case, the particle is coated with an antibody to resemble the biological conditions found upon injection in the bloodstream. Other components of the blood plasma like lipoproteins are also investigated with this technique.
