...
\begin{figure}
	\centering
		...
		\caption{The phospholipid bilayer scattering feature: High $q$-region of the scattering curves of 2 plain liposomes and the 3 largest SSLs in buffer.}
...
\begin{figure}
	\centering
		...
		\subfloat[Plain 89 nm]{\resizebox{0.44\linewidth}{!}{\input{Figures/PlainLiposomeContinuousSAXS}}\label{fig:PlainLiposomeContinuousSAXS}}
		\caption{Scattering curves of the 81 nm SSL and the 89 nm plain liposomes measured at different solvent osmolalities with an aqueous sucrose density gradient. The positions of the pseudo isoscattering points at $q=0.18$ nm$^{-1}$ and $q=0.16$ nm$^{-1}$ are marked for the PEGylated and plain lipsomes respectively.}
\end{figure}
