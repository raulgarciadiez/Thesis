...
\begin{figure}%[htbp]
	\centering
		...
		\caption[Experimental scattering curves of PS-COOH nanoparticles for different suspending medium electron densities.]{Experimental scattering curves of PS-COOH nanoparticles for different suspending medium electron densities measured between 78 and 93 minutes after the inception of the density gradient. The dashed line shows the experimental background, containing scattering contributions from the capillary and the pure solvent.}
...
\begin{figure}%[htbp]
	\centering
		...
		\caption[Background subtraction of the PS-COOH scattering curves.]{The thick red line shows the scattering curve measured at $\rho_{\text{solv}}$ = 345.4 nm$^{-3}$, close to the match point, and the dotted line displays the experimental background. The symbols with errorbars show the background corrected scattering curve.}
...
\begin{figure}%[htbp]
	\centering
		...
		\caption[Concentration gradient of 12 nm silica particles mesaured at 8000 eV.]{Concentration gradient of 12 nm silica particles mesaured at 8000 eV. The large size of the colloids provides a longer diffusion time than a typical contrast agent like sucrose.}
