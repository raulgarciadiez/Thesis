...
\section{Proof of principle with PS-COOH colloids: Experimental results}
...
\begin{figure}%[htbp]
	\centering
		...
		\caption{Experimental scattering curves of polystyrene nanoparticles (PS-COOH) for different suspending medium electron densities measured between 78 and 93 minutes after the inception of the density gradient. The dashed line shows the experimental background, containing scattering contributions from the capillary and the pure solvent.}
