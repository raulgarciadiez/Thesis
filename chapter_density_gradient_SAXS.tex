...
\begin{figure}%[htbp]
	\centering
		...
		\caption[Deviation from the $I(0)$ used in the evaluation of the PS-COOH data.]{Deviation from the $I(0)$ values used in the data evaluation: The Guinier approximation overestimates the experimental values, while the intensity at $q=0.03$ nm$^{-1}$ underestimates the zero-angle intensity.}
