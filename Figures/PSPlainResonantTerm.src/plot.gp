...
p NaN w p ls 1 t 'Experimental Data', 'AutoSAXS_fitresults.dat' u 1:($2/1.e13):($4/1.e13) w yerrorbars ls 1 notitle, '' u 1:($3/1.e13) ls 2 w l t 'Spherical Model','' u 1:($2/1.e13) ls 1 notitle
