...
p NaN w p ls 1 ps 1.5 t '\smaller Shape scattering function', 'AutoSAXS_fitresults.dat' u 1:($2/1.e13):($4/1.e13) w yerrorbars ls 1 ps 1.5 notitle, '' u 1:($3/1.e13) ls 2 w l t '\smaller Spherical model','' u 1:($2/1.e13) ls 1 ps 1.5 notitle
