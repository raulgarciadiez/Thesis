...
set ytics   (0.0200000, 0.0500000, 0.100000, 0.200000)
...
set yrange [ 0.0150000 : 0.300000 ] noreverse nowriteback
...
set cbrange [ 0.0190000 : 0.0210000 ] noreverse nowriteback
set zero 1e-08
set lmargin  -1
set bmargin  -1
set rmargin  -1
...
plot "Hilgenberg-93.5.dat" u 2:3 w lp pt 7 title "Transmission", luft title "Glass only", wasser title "H_2O", galden title "Galden"
set term push
set term post col sol eps enh "Times-Roman" 24
set out "mu-hilgenberg.eps"
rep
set out
set term pop
! eps2png mu-hilgenberg.eps 200
#    EOF
