...
# set terminal png nocrop font "arial,12" fontscale 1.0 size 220,700 
# set output
unset clip points
set clip one
unset clip two
...
set cbtics   (0.0100000, 0.0200000, 0.0500000, 0.100000, 0.200000, 0.500000, 1.00000)
...
set colorbox user
set colorbox vertical origin graph 1.2, 0, 0 size graph 0.2, 1, 0 front bdefault
...
FIT_CONVERGED = 1
FIT_NDF = 10
FIT_STDFIT = 5.14591541463188e-05
FIT_WSSR = 2.6480445454546e-08
wasser = 0.07197752
galden = 0.0206771636363637
splot "Hilgenberg-1mm-sep.dat" u ($1-91.5):2:3 w pm3d
...
set terminal postscript eps enhanced defaultplex \
   ...
   size 1.80in, 3.50in "Times-Roman" 14  fontscale 1.3

set output "Hilgenberg.eps"
rep
set out
set term pop
! eps2png Hilgenberg.eps 300
