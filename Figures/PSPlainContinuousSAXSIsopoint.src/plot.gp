...
set ylabel 'Rel. Std. Deviation' offset 1,0.3
set autoscale
...
set label '$I_1$' at 0.055,0.08
set label '$I_2$' at 0.095,0.06
set label '$I_3$' at 0.135,0.05
set label '$I_4$' at 0.1752,0.08
