...
set autoscale
set xrange [0.35:2.]
set yrange [5.e-1:2e2]
set key spacing 1.2 samplen 2 width -5 at 1.5, 1.8
set xtics (0.5, 1, 2.)
...
set style line 1  lc rgb '#0025ad' lt 1 lw 6 # --- blue
set style line 2  lc rgb '#0060ad' lt 1 lw 6 #      .
set style line 3  lc rgb '#0099ad' lt 1 lw 6 #      .
set style line 4  lc rgb '#00ad88' lt 1 lw 6 #      .
set style line 5 lc rgb '#00ad4e' lt 1 lw 6 #      .
set style line 6 lc rgb '#09ad00' lt 1 lw 6 # --- green

set style line 7  lc rgb '#DF0101' lt 1 lw 6 #---- red
set style line 8 lc rgb '#8A0808' lt 1 lw 6 #      .
set style line 9 lc rgb '#190707' lt 1 lw 6 # --- black
...
p 'HSPC_PEG_80_May.dat' u 1:($2*1.3*2-1) w l ls 4 t '\smaller PEG 103 nm','HSPC_PEG_200_May.dat' u 1:($2*1.4*4-2.63) w l ls 2 t '\smaller PEG 179 nm', 'HSPC_PEG_400_May.dat' u 1:($2*1.6*8-6) w l ls 1 t '\smaller PEG 274 nm', 'HSPC_50_sucr_WAXS.dat' u 1:($2*25) w l ls 7 t '\smaller plain 89 nm', 'HSPC_100_sucr_WAXS.dat' u 1:($2*1.5*2*10) w l ls 9 t '\smaller plain 128 nm'
