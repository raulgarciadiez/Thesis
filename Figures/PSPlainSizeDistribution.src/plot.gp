...
p 'PS4_TSEM.dat' every ::1 u 1:($2/150.) w boxes fill lc rgb 'grey' t '\smaller TSEM', gauss(x,73.4,1.9284) ls 1 t '\smaller Shape Scat. Func. SAXS', 'PS4_DLS_Normal_disc.dat' u 1:7 w l ls 2 t '\smaller Standard DCS','PS4_DLS_Low_disc.dat' u 1:7 w l ls 3 t '\smaller Low density DCS'
