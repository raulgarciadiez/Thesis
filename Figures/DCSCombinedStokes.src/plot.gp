...
set key at 1.105,325


set arrow from 1.052,200 to 1.052,155 head ls 3 #lw 3 lc rgb 'grey'

p 'DCS_results.dat' u 1:3:($1-$2):($1+$2):($3-$4):($3+$4) w xyerrorbars ls 1 t '\smaller Standard disc', '' u 1:3 w l ls 1 notitle, '' u 6:8:($6-$7):($6+$7):($8-$9):($8+$9) w xyerrorbars ls 2 t '\smaller Low density disc', '' u 6:8 w l ls 2 notitle
