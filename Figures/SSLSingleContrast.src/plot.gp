...
p 'DEF_HSPC_PEG_50_Oct.dat' w l ls 6 t 'PEG 81 nm', 'DEF_HSPC_PEG_80_Oct.dat' u 1:($2*1.5) w l ls 5 t 'PEG 87 nm', 'HSPC_PEG_80_May.dat' u 1:($2*1.3*2) w l ls 4 t 'PEG 103 nm','HSPC_PEG_200_May.dat' u 1:($2*1.4*4) w l ls 2 t 'PEG 179 nm', 'HSPC_PEG_400_May.dat' u 1:($2*1.6*5) w l ls 1 t 'PEG 274 nm', 'DEF_HSPC_50_Oct.dat' u 1:($2*50) w l ls 7 t 'plain 89 nm', 'HSPC_80_Oct.dat' u 1:($2*1.5*50) w l ls 8 t 'plain 116 nm', 'DEF_HSPC_100_Oct.dat' u 1:($2*1.5*2*50) w l ls 9 t 'plain 128 nm'
