...
\begin{figure}%[htbp]
	\centering
		\subfloat[Scattering curves]{\resizebox{0.44\linewidth}{!}{\fontsize{12pt}{12pt}\selectfont\input{Figures/PSPlainContinuousSAXS}}\label{fig:PSPlainContinuousSAXS}}
		\subfloat[Isoscattering point positions]{\resizebox{0.44\linewidth}{!}{\fontsize{12pt}{12pt}\selectfont\input{Figures/PSPlainContinuousSAXSIsopoint}}\label{fig:PSPlainContinuousSAXSIsopoint}}
