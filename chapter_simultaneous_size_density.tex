...
\textcolor{red}{the uncertainty of the isoscattering points due to the diffuseness of $q^{\star}$ is the largest contribution to the size obtained using this method.}
